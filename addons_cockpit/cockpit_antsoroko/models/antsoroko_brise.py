...
class AntsorokoBrise(models.Model):
    _name = 'antsoroko.brise'
    _description = 'Antsoroko Brisé - Sortie'
    ...
    def _compute_name(self):
        for rec in self:
            ...
            rec.name = f"Brisé {rec.vehicule or ''} {date_str} {rec.quantite or 0}Kg"
