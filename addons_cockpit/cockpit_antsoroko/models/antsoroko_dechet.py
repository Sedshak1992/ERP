...
class AntsorokoDechet(models.Model):
    _name = 'antsoroko.dechet'
    _description = 'Antsoroko Déchet - Sortie'
    ...
    def _compute_name(self):
        for rec in self:
            ...
            rec.name = f"Déchet {rec.vehicule or ''} {date_str} {rec.quantite or 0}Kg"
