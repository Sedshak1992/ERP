...
class AntsorokoExtra(models.Model):
    _name = 'antsoroko.extra'
    _description = 'Antsoroko Extra - Sortie'
    ...
    def _compute_name(self):
        for rec in self:
            ...
            rec.name = f"Extra {rec.vehicule or ''} {date_str} {rec.quantite or 0}Kg"
