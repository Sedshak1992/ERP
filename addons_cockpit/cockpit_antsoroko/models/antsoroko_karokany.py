...
class AntsorokoKarokany(models.Model):
    _name = 'antsoroko.karokany'
    _description = 'Antsoroko Karokany - Sortie'
    ...
    def _compute_name(self):
        for rec in self:
            ...
            rec.name = f"Karokany {rec.vehicule or ''} {date_str} {rec.quantite or 0}Kg"
